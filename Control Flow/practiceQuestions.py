...
#  nominated in that year (as value). We've provided you with a different dictionary called "winners" with the year 
# (as key) and list of directors who won the award in that year (as value).
...
nom_count_dict = {}
# Add your code here
for year,nominie in nominated.items():
    nominie = tuple(nominie)
    for name in nominie:
...
for name,times in win_count_dict.items():
    if times == highest_count:
